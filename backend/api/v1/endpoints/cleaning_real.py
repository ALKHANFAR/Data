...
def process_cleaning_job(job_id: str, file_id: str, settings_dict: dict):
    ...
    try:
        ...
        stats = {
            ...
            'quality_score': float((valid_rows / total_rows * 100) if total_rows > 0 else 0),
